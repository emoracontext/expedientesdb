...
define('PHPGRID_DB_HOSTNAME', 'dealerbest-sql'); // database host name
define('PHPGRID_DB_USERNAME', 'gestorweb');     // database user name
define('PHPGRID_DB_PASSWORD', 'RubberDuck99'); // database password
define('PHPGRID_DB_NAME', 'gestorV'); // database name
