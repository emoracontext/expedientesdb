...
<button class="accordion" style="color: #003399; font-weight: bold">FILTROS DE BUSQUEDA</button>
    <div class="panel">
        <form action="{{url('busqueda_movimiento')}}" method="POST">     
            @csrf  
            <table style="width: 100%" class="table table-sm table-striped" >              
                ...
                <tr class="align-bottom table-info table-responsive-sm small">
                    <th>Id Expediente</th> 
                    <th><input type="number" name="idExp"></th> 
                ...
                <tr class="align-bottom table-info table-responsive-sm small" style="text-align:center;">
                    <th colspan="8" style="padding-top: 20px; padding-bottom: 20px;"><input type="submit" value="FILTRAR"></th>                                             
                </tr> 
            </table>  
        </form>
    </div>
    ...
    <table style="width: 100%" class="table table-sm table-striped">
        <thead class="thead">                  
            <tr class="align-bottom table-info table-responsive-sm small">
                <th class="align-bottom" style=" width: 10%"><input type="button" id="id_log" value="Id Log" class="ordenar"></th>
                <th class="align-bottom" style=" width: 10%"><input type="button" id="id_rivera" value="Id en Rivera" class="ordenar"></th> 
                <th class="align-bottom" style=" width: 10%"><input type="button" id="id_user" value="Id Users" class="ordenar"></th> 
                <th class="align-bottom" style=" width: 30%"><input type="button" id="descrip" value="Descripcion" class="ordenar"></th> 
                <th class="align-bottom" style=" width: 15%"><input type="button" id="fecha_log" value="Fecha" class="ordenar"></th>                                  
                <th class="align-bottom" style=" width: 15%"><input type="button" id="ip_log" value="Ip" class="ordenar"></th> 
                <th class="align-bottom" style=" width: 10%"><input type="button" id="expediente" value="Id Expediente" class="ordenar"></th> 
            </tr>  
        </thead>                       
...
var acc = document.getElementsByClassName("accordion");
    ...
    NO HAY REGISTROS QUE COINCIDAN CON LOS VALORES DE BUSQUEDA</th> \n\
            ...
            for (var i = sta; i < limit; i++) {
                ...
                var link = "<a href='/expedientesFicha/" + id + "'>Doc</a>";
                     ...
                     <th>' + b[i]['idUsuario'] + '</th> \n\
                     <th>' + b[i]['id_users'] + '</th> \n\
                     <th>' + b[i]['descripcion'] + '</th>\n\
                     <th>' + b[i]['fechaHora'] + '</th>\n\
                     <th>' + b[i]['ip'] + '</th>\n\
                     <th>' + b[i]['id_expediente'] + '</th>\n\
</tr>');
            ...
            table.append("<tr style=\"border-top: solid white 20px !important;\"><th colspan='2' style=\"padding-left:5%;\">" + max_size + " elementos</th>\n\
    <th colspan='2' style=\"text-align:center; padding-right: 5%;\">Resultados: " + (sta + 1) + " - " + limit + "</th>\n\
    <th colspan='2' style=\"text-align:center; padding-right: 5%;\">Página " + actual + " de " + page + "</th></tr>");
        }
    ...
    <td>Ir a la página: <select id=\'select_id\'>';
        ...
        $('#fecha_log').click(function () {
            ...
            if (ini === 0) {
                b.sort(function (a, c) {
                    return c.fechaHora.localeCompare(a.fechaHora);
                });
                ini++;
            } else {
                b.sort(function (a, c) {
                    return a.fechaHora.localeCompare(c.fechaHora);
                });
                ini--;
            }
